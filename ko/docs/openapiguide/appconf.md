---
title: 내 애플리케이션 관리
description: 개발자센터에서 등록한 애플리케이션의 기본 정보, API 설정, 멤버 관리, 통계 보기, 삭제 등 관리 방법을 안내합니다.
---

# 내 애플리케이션 관리

개발자 센터의 **[Application > 내 애플리케이션](/myapps)** 메뉴를 클릭하면 등록한 애플리케이션의 목록을 확인할 수 있습니다. 목록 위에 있는 **Application 등록**을 클릭하면 새로운 애플리케이션을 등록할 수 있습니다. 애플리케이션은 최대 10개까지 등록할 수 있습니다.
...
애플리케이션 관리 페이지의 **API 설정** 탭을 클릭하면 애플리케이션을 등록할 때 설정한 [세부 정보](/docs/openapiguide/appregister#애플리케이션-등록-세부-정보)를 확인하고 수정할 수 있으며, 카테고리와 로고 이미지를 추가로 설정할 수 있습니다. 애플리케이션이 [로그인 방식 오픈 API](/docs/openapiguide/apilist#로그인-방식-오픈-api)를 사용한다면 애플리케이션 개발 상태도 확인하고 변경할 수 있습니다.
...
> **주의**  
> 애플리케이션 개발 상태를 '서비스 적용'으로 하기 위해서는 반드시 검수요청을 등록해야 합니다. [검수 요청 등록 가이드](/docs/login/verify)를 참고하십시오.
