...
* [GitHub에서 보기](https://github.com/naver/naver-openapi-guide/blob/master/sample/java/ApiExamCaptchaSkey.java)
...
public class ApiExamCaptchaSound {
    ...
    public static void main(String[] args) {
        ...
        String key = "YOUR_CAPTCHA_KEY"; // hhttps://openapi.naver.com/v1/captcha/skey 호출로 받은 키값
    ...
    private static String getImage(InputStream is){
        ...
        try(OutputStream outputStream = new FileOutputStream(f)){
            ...
            return "음성 캡차가 생성되었습니다.";
        } catch (IOException e) {
            throw new RuntimeException("음성 캡차 파일 생성에 실패 했습니다.",e);
        }
    }
...
* [GitHub에서 보기](https://github.com/naver/naver-openapi-guide/blob/master/sample/java/ApiExamCaptchaSound.java)
...
public class ApiExamCaptchaSkeyResult {
    ...
    public static void main(String[] args) {
        ...
        String value = "YOUR_INPUT"; // 사용자가 입력한 캡차 음성 글자값
...
* [GitHub에서 보기](https://github.com/naver/naver-openapi-guide/blob/master/sample/java/ApiExamCaptchaSkeyResult.java)
...
* [GitHub에서 보기](https://github.com/naver/naver-openapi-guide/blob/master/sample/php/APIExamCaptchaSkey.php)
...
* [GitHub에서 보기](https://github.com/naver/naver-openapi-guide/blob/master/sample/php/APIExamCaptchaSound.php)
...
* [GitHub에서 보기](https://github.com/naver/naver-openapi-guide/blob/master/sample/php/APIExamCaptchaSkeyResult.php)
...
var code = "0";
app.get('/captcha/skey', function (req, res) {
   var api_url = 'https://openapi.naver.com/v1/captcha/skey?code=' + code;
...
* [GitHub에서 보기](https://github.com/naver/naver-openapi-guide/blob/master/sample/nodejs/APIExamCaptchaSkey.js)
...
* [GitHub에서 보기](https://github.com/naver/naver-openapi-guide/blob/master/sample/nodejs/APIExamCaptchaSound.js)
...
app.get('/captcha/result', function (req, res) {
   var api_url = 'https://openapi.naver.com/v1/captcha/skey?code=' + code + '&key=' + req.query.key + '&value=' + req.query.value;
   var request = require('request');
   var options = {
       url: api_url,
       headers: {'X-Naver-Client-Id':client_id, 'X-Naver-Client-Secret': client_secret}
...
* [GitHub에서 보기](https://github.com/naver/naver-openapi-guide/blob/master/sample/nodejs/APIExamCaptchaSkeyResult.js)
...
* [GitHub에서 보기](https://github.com/naver/naver-openapi-guide/blob/master/sample/python/APIExamCaptchaSkey.py)
...
* [GitHub에서 보기](https://github.com/naver/naver-openapi-guide/blob/master/sample/python/APIExamCaptchaSound.py)
...
* [GitHub에서 보기](https://github.com/naver/naver-openapi-guide/blob/master/sample/python/APIExamCaptchaSkeyResult.py)
...
* [GitHub에서 보기](https://github.com/naver/naver-openapi-guide/blob/master/sample/c%23-asp.net/APIExamCaptchaSkey.cs)
...
* [GitHub에서 보기](https://github.com/naver/naver-openapi-guide/blob/master/sample/c%23-asp.net/APIExamCaptchaSound.cs)
...
* [GitHub에서 보기](https://github.com/naver/naver-openapi-guide/blob/master/sample/c%23-asp.net/APIExamCaptchaSkeyResult.cs)
