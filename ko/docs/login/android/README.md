---
title: 네이버 로그인 Android SDK 개발가이드
description: 네이버 아이디 로그인 Android SDK(네아로SDK)를 사용해 서드파티 애플리케이션에서 로그인, 로그아웃, 토큰 관리 등의 기능을 구현하는 방법을 안내합니다.
---
...
<div class="ndc-cta">
<a href="https://github.com/naver/naveridlogin-sdk-android">라이브러리 및 샙플앱 보기 &gt;</a>
<a href="https://github.com/naver/naveridlogin-sdk-android/issues">이슈 등록 &gt;</a>
...
> **주의** <br/>
> `NidLoginButton` 객체를 이용할 때 네이버 로그인 버튼의 디자인은 반드시 [네이버 로그인 버튼 사용 가이드](/docs/login/bi)를 따라야 합니다. <br/>
