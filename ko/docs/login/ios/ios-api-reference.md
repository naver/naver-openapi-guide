---
title: 네이버 로그인 iOS SDK API 레퍼런스
description: 네이버 아이디로 로그인 iOS SDK가 제공하는 NidOAuth, LoginBehavior, LoginResult, NidError 등 클래스와 메서드의 API 레퍼런스입니다.
---
...
> **참고** <br/>
>
> [네이버 로그인 에러 코드](/docs/openapiguide/errorcode#주요-오류-코드)
