---
title: 네이버 로그인 iOS SDK 개발가이드
description: 네이버 아이디로 로그인 iOS SDK 최신 버전(Swift)을 사용해 서드파티 애플리케이션에서 로그인, 로그아웃, 토큰 관리 등의 기능을 구현하는 방법을 안내합니다.
---
...
<div class="ndc-cta">
<a href="https://github.com/naver/naveridlogin-sdk-ios-swift">라이브러리 및 샘플앱 보기 &gt;</a>
<a href="https://github.com/naver/naveridlogin-sdk-ios-swift/issues">이슈 등록 &gt;</a>
...
위 메소드 인자로 넘기는 애플리케이션 설정 값들은 [오픈 API 이용 신청 >](/myapps/new) 후, `Application` > `내 애플리케이션` > 앱 선택을 통해 확인할 수 있습니다.
...
> **참고**<br> [NidError](/docs/login/ios/ios-api-reference#6--niderror)
...
> **참고**<br>
>
> [AccessToken](/docs/login/ios/ios-api-reference#4--accesstoken) <br>
>
> [RefreshToken](/docs/login/ios/ios-api-reference#5--refreshtoken)
