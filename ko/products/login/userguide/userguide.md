...
<div class="con">
    ...
    <div class="img_area"><img alt="" src="./images/img_naverid_01.png"></div>
    <p class="p_desc">
    ...
    <div class="img_area"><img alt="" src="./images/img_naverid_02.png"></div>
    ...
    <div class="img_area"><img alt="" src="./images/img_naverid_03.png"></div>
    <p class="p_desc">
        1.2. 공간에 제약이 있는 경우
    </p>
    <div class="img_area"><img alt="" src="./images/img_naverid_04.png"></div>
    <p class="p_desc">
        1.3. PC와 모바일 환경 모두에 네이버 로그인 버튼을 사용합니다.
    </p>
    <div class="img_area"><img alt="" src="./images/img_naverid_05.png"></div>
    <div class="blockquote_area">
    ...
    <div class="img_area"><img alt="" src="./images/img_naverid_06.png"></div>
    <div class="blockquote_area">
    ...
    <div class="img_area"><img alt="" src="./images/img_naverid_07.png"></div>
    <p class="p_desc">
        2.2 네이버에서 제공하는 정보로 충분하지만 이용자에게 재입력 받고 싶은 정보가 있는 경우
    </p>
    <div class="img_area"><img alt="" src="./images/img_naverid_08.png"></div>
    <p class="p_desc">
        2.3. 네이버가 제공하는 정보외 추가로 필요할 경우
    </p>
    <div class="img_area">
        <img alt="" src="./images/img_naverid_09.png"></div>
    ...
    <div class="img_area"><img alt="" src="./images/img_naverid_10.png"></div>
    ...
    <div class="img_area"><img alt="" src="./images/img_naverid_11.png"></div>
    ...
    <div class="img_area"><img alt="" src="./images/img_naverid_12.png"></div>
    <div class="blockquote_area">
        <strong class="color_p3"><i class="xi-info-suqare"></i> 로그인 후 곧바로 기존 아이디와 비밀번호를 요구하지 마세요</strong>
        <p>이미 네이버 계정으로 로그인 한 사용자에게, 기존에 사이트에 가입한 계정과 연동시키려는 목적으로 기존 ID/PW를 요구하는 것은 사용자를 불편하게 하는 절차입니다. 사용자가 직접 ID/PW를 입력하지 않아도 되게끔, 이메일 등의 정보로 기존 가입 여부를 먼저 확인해주세요. 만약 가입된 적이 없다면 신규가입 처리를, 이미 가입 되었다면 기존 계정을 안내하여 자연스럽게 연동 절차를 제공하세요.</p>
    </div>
    <div class="img_area"><img alt="" src="./images/img_naverid_13.png"></div>
    ...
    <div class="img_area"><img alt="" src="./images/img_naverid_14.png"></div>
    ...
    <div class="img_area"><img alt="" src="./images/img_naverid_15.png"></div>
    <div class="blockquote_area">
        <strong>권장형태</strong>
        <p>
