...
<div class="con">
    ...
    <div id='tutorial2' class="faq_w">
        ...
        <dl>
            ...
            <dt>
            Q. 영문으로 된 서비스를 제공 중입니다. 네이버 로그인를 영문으로 적용하고 싶은데 영문으로 된 페이지를 제공하고 있나요?
            </dt>
            <dd>
            네이버 로그인는 사용자 브라우저의 Locale 설정을 기준으로 한글 페이지, 영문, 중문 페이지를 제공하고 있습니다.<br/>
            ...
            <dd>
            네이버 로그인는 영문 개발가이드를 별도로 제공하고 있습니다.<br/>
        ...
        -->
            <dt>
            Q. 우리 서비스에 네이버 로그인를 적용하려고 합니다. 적용에 필요한 절차나 가이드가 있나요?
            </dt>
            <dd>
            ...
            <dt>
            Q. 안드로이드 (또는 아이폰) 앱에 네이버 로그인를 적용할 예정입니다.<br/>아직 앱스토어 앱등록을 하지 않아 "다운로드 URL"이 없는 상태인데 개발자 센터에 애플리케이션 등록이 가능한가요?
            </dt>
            <dd>
        ...
        -->
            ...
            <dd>
            네이버 로그인는 오픈 API 약관에 따라 무료로 제공되고 있습니다.<br/>
            제휴가 필요한 경우 심사를 통하여 제휴를 체결하여 드리고 있으며, 제휴를 통한 오픈 API 사용 또한 무료로 이용이 가능합니다.
            </dd>
            <dt>
            Q. 사내 네트워크에서 네이버 로그인를 개발 중입니다. 방화벽이 적용되어있는 경우 어떠한 IP와 PORT를 열어야하나요?
            </dt>
            <dd>
